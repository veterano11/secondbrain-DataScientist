---
tags: [moc, infrastructure, devops, terraform, aws]
status: growing
created: 2026-06-28
---
...
- [[Terraform State & Backends]] — State file, S3 backend, DynamoDB locking, remote state
...
Core         → Terraform Foundations, Terraform State & Backends
Advanced     → Terraform Modules, AWS CodeBuild with Terraform
```
